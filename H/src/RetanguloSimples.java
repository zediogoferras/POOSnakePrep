...
public class RetanguloSimples extends Retangulo{
    ...
    /**
     * Rotates the simple rectangle "angle" degrees clockwise about the point c
     * @return rotated RetanguloSimples
     */
    public RetanguloSimples rotate(int angle, Ponto c){
        return (RetanguloSimples) super.rotate(angle,c);
    }

    /**
     * Rotates the simples rectangle "angle" degrees clockwise about the centroid
     * @return rotated RetanguloSimples
     */
    public RetanguloSimples rotate(int angle){
